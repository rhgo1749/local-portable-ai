...
const CDN_WASM_LINK = `https://cdn.jsdelivr.net/npm/@hyzyla/pdfium@${"2.1.13"}/dist/pdfium.wasm`;
const WASM_INTEGRITY = `sha256-${"ca7EEqMDoEBbruIcPW0/MK0gM9wCREEw/kdr45duLQk="}` ;

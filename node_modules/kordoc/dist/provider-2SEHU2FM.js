...
async function ocrPages(doc, provider, pageFilter, effectivePageCount) {
  ...
  for (let i = 1; i <= effectivePageCount; i++) {
    ...
    try {
      ...
      console.error(`[kordoc render error] Page ${i} render failed:`, err);
      blocks.push({ type: "paragraph", text: `[OCR \uC2E4\uD328: \uD398\uC774\uC9C0 ${i} - ${err.message}]` });
    }
  }
  return blocks;
}
...
//# sourceMappingURL=provider-2SEHU2FM.js.map